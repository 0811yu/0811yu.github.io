...
def run(weights=ROOT / 'runs/train/exp97/weights/best.pt',  # model.pt path(s)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp97/weights/best.pt', help='model path(s)')
